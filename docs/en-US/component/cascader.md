...
| default-first-option ^(2.14.7)                | whether to highlight the first available option when opened or filtered; pressing Enter confirms a highlighted suggestion                                                        | ^[boolean]                                                                                                                                                                  | false        |
| filter-value / v-model:filter-value ^(2.14.6) | binding value of the filter input; the value is restored when the dropdown is reopened                                                                                           | ^[string]                                                                                                                                                                   | —            |
