...
| default-first-option ^(2.14.7)                | whether to highlight the first available option when opened or filtered; pressing Enter confirms the highlighted option                                                          | ^[boolean]                                                                                                                                                                  | true         |
